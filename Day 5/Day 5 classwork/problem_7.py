#Find the maximum number in the first row
#Then go to the maximum number in the 2nd row compared to the first row
# then continue this till the last row
#if the next row doesnot contains any element greater the the current row, then stop there
